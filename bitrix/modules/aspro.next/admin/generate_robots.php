			...
			if($arTab["SITE_ID"])
			{
				...
				<tr>
					...
					<td style="width:50%;">
						...
						$href = "javascript: new BX.CAdminDialog({'content_url':'/bitrix/admin/public_file_edit.php?site=".$optionsSiteID."&bxpublic=Y&from=includefile&templateID=".$arTab['TEMPLATE']['ID']."&path=".$arTab["SITE_DIR"]."robots.txt&lang=".LANGUAGE_ID."&noeditor=Y&template=include_area.php&subdialog=Y&siteTemplateId=".$arTab['TEMPLATE']['ID']."','width':'1009','height':'503'}).Show();";
					...
					<?if($arTab["ITEMS"])
					{
						foreach($arTab["ITEMS"] as $arItem):?>
							<tr>
								...
								<td style="width:50%;">
									<?$template = 'include_area.php';
									$href = "javascript: new BX.CAdminDialog({'content_url':'/bitrix/admin/public_file_edit.php?site=".$optionsSiteID."&bxpublic=Y&from=includefile&templateID=".$arTab['TEMPLATE']['ID']."&path=".$arTab["SITE_DIR"]."aspro_regions/robots/robots_".$arItem["PROPERTY_MAIN_DOMAIN_VALUE"].".txt&lang=".LANGUAGE_ID."&noeditor=Y&template=include_area.php&subdialog=Y&siteTemplateId=".$arTab['TEMPLATE']['ID']."','width':'1009','height':'503'}).Show();";
									?><a class="adm-btn" href="<?=$href?>" name="edit" title="<?=GetMessage('NEXT_MODULE_EDIT_ROBOTS')?>"><?=GetMessage('NEXT_MODULE_EDIT_ROBOTS')?></a>
