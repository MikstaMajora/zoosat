			...
			$arMenu = array(
				...
				'items' => array(
					...
					array(
						...
						'sort' => 50,
						'url' => '/bitrix/admin/'.$moduleID.'_sync_stores.php?mid=main&lang='.urlencode(LANGUAGE_ID),
						'icon' => 'util_menu_icon',
						'page_icon' => 'pi_sync',
						'items_id' => 'main',
					),
					array(
						...
						"items" => array(
							array(
								...
								'sort' => 10,
								'url' => '/bitrix/admin/'.$moduleID.'_crm_amo.php?mid=main&lang='.urlencode(LANGUAGE_ID),
								'icon' => '',
								'page_icon' => 'pi_typography',
								'items_id' => 'crm_amo',
							),
							array(
								...
								'sort' => 20,
								'url' => '/bitrix/admin/'.$moduleID.'_crm_flowlu.php?mid=main&lang='.urlencode(LANGUAGE_ID),
								'icon' => '',
								'page_icon' => 'pi_typography',
								'items_id' => 'crm_flowlu',
							),
					...
					array(
						...
						'items' => array(
							array(
								...
								'sort' => 10,
								'url' => '/bitrix/admin/'.$moduleID.'_generate_robots.php?mid=main&lang='.urlencode(LANGUAGE_ID),
								'icon' => '',
							...
							array(
								...
								'sort' => 20,
								'url' => '/bitrix/admin/'.$moduleID.'_generate_sitemap.php?mid=main&lang='.urlencode(LANGUAGE_ID),
								'icon' => '',
					...
					array(
						...
						'sort' => 80,
						'url' => '/bitrix/admin/'.$moduleID.'_options_ym.php?mid=main&lang='.urlencode(LANGUAGE_ID),
						'icon' => 'statistic_icon_online',
						'page_icon' => 'pi_yamarket',
						'items_id' => 'ymindex_link',
					),
					// array(
					// 	'text' => GetMessage('ASPRO_NEXT_MENU_GS_TEXT'),
					// 	'title' => GetMessage('ASPRO_NEXT_MENU_GS_TITLE'),
					// 	'sort' => 1000,
