...
if($action){
	if($action === 'init' || $action === 'save'){
		...
		$eventManager->RegisterEventHandler('catalog', 'OnCondCatControlBuildList', 'aspro.next', '\Aspro\Next\Property\ModalConditions\CondModal', 'GetControlDescr');
		...
		$eventManager->UnRegisterEventHandler('catalog', 'OnCondCatControlBuildList', 'aspro.next', '\Aspro\Next\Property\ModalConditions\CondModal', 'GetControlDescr');
