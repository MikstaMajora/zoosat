...
Option::set('aspro.next', "SOCIAL_VIBER", $wizard->GetVar("shopViber"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_WHATS", $wizard->GetVar("shopWhats"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_TIKTOK", $wizard->GetVar("shopTikTok"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_ZEN", $wizard->GetVar("shopZen"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_PINTEREST", $wizard->GetVar("shopPinterest"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_SNAPCHAT", $wizard->GetVar("shopSnapchat"), WIZARD_SITE_ID);
Option::set('aspro.next', "SOCIAL_LINKEDIN", $wizard->GetVar("shopLinkedin"), WIZARD_SITE_ID);
