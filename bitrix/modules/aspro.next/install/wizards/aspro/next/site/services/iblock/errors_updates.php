...
$skuIBlockID = CNextCache::$arIBlocks[WIZARD_SITE_ID]["aspro_next_catalog"]["aspro_next_sku"][0];
$stockIBlockID = CNextCache::$arIBlocks[WIZARD_SITE_ID]['aspro_next_content']['aspro_next_stock'][0];
