...
$iblockXMLID = "aspro_next_".$iblockShortCODE."_".$wizardSiteId;
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--ID--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_4").'--,--PROPERTY_'.$arProperty["MODAL_TYPE"].'--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--PROPERTY_'.$arProperty["HIDE_TITLE"].'--#--'.GetMessage("WZD_OPTION_10").'--,--CODE--#--'.GetMessage("WZD_OPTION_12").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_14").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["LINK_WEB_FORM"].'--#--'.GetMessage("WZD_OPTION_18").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_20").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_56").'--,--PROPERTY_'.$arProperty["POSITION"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["DELAY_SHOW"].'--#--'.GetMessage("WZD_OPTION_24").'--,--PROPERTY_'.$arProperty["LS_TIMEOUT"].'--#--'.GetMessage("WZD_OPTION_26").'--,--PROPERTY_'.$arProperty["FILTER_SHOW"].'--#--'.GetMessage("WZD_OPTION_28").'--;--edit1_csection1--#--'.GetMessage("WZD_OPTION_30").'--,--PROPERTY_'.$arProperty["BTN1_TEXT"].'--#--'.GetMessage("WZD_OPTION_32").'--,--PROPERTY_'.$arProperty["BTN1_LINK"].'--#--'.GetMessage("WZD_OPTION_34").'--,--PROPERTY_'.$arProperty["BTN1_CLASS"].'--#--'.GetMessage("WZD_OPTION_36").'--,--PROPERTY_'.$arProperty["BTN2_TEXT"].'--#--'.GetMessage("WZD_OPTION_38").'--,--PROPERTY_'.$arProperty["BTN2_LINK"].'--#--'.GetMessage("WZD_OPTION_40").'--,--PROPERTY_'.$arProperty["BTN2_CLASS"].'--#--'.GetMessage("WZD_OPTION_42").'--;--cedit2--#--'.GetMessage("WZD_OPTION_44").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_44").'--;--cedit3--#--'.GetMessage("WZD_OPTION_46").'--,--PROPERTY_'.$arProperty["USER_GROUPS"].'--#--'.GetMessage("WZD_OPTION_48").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_50").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_52").'--;----#--'.GetMessage("WZD_OPTION_54").'--;--',
	));
...
if($iblockID){
	...
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_DOCS_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_DOCS_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_DOCS_CODE" => $iblockCODE));
