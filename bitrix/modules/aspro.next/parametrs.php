...
$moduleClass::$arParametrsList = array(
	...
	'MENU' => array(
		...
		'OPTIONS' => array(
			...
			'USE_MEGA_MENU' => array(
				'TITLE' => GetMessage('USE_MEGA_MENU_TITLE'),
				'TYPE' => 'checkbox',
				'DEPENDENT_PARAMS' => array(
					'REPLACE_TYPE' => array(
	...
	'CATALOG_PAGE' => array(
		...
		'OPTIONS' => array(
			...
			'SHOW_DELAY_BUTTON' => array(
				'TITLE' => GetMessage('SHOW_DELAY_BUTTON_TITLE'),
				'TYPE' => 'checkbox',
				'DEFAULT' => 'Y',
				'THEME' => 'N',
			),
			...
			'CATALOG_LINKED_PROP' => array(
				'TITLE' => GetMessage('CATALOG_LINKED_PROP_TITLE'),
				'TYPE' => 'multiselectbox',
				'TYPE_SELECT' => 'LINKED_PROP_CATALOG',
				'DEFAULT' => '',
				'ONE_ROW' => 'Y',
				'THEME' => 'N',
			),
			'CATALOG_LINKED_PROP_NOTE' => array(
				'TYPE' => 'note',
				'TITLE' => GetMessage('CATALOG_LINKED_PROP_NOTE_TEXT'),
				'THEME' => 'N',
			),
			...
			'GALLERY_ITEM_SHOW' => array(
				'TITLE' => GetMessage('GALLERY_ITEM_SHOW_TITLE'),
				'TYPE' => 'checkbox',
				'ONE_ROW' => 'Y',
				'DEPENDENT_PARAMS' => array(
					...
					'ADD_DETAIL_TO_GALLERY_IN_LIST' => array(
						'TITLE' => GetMessage('ADD_DETAIL_TO_GALLERY_IN_LIST_TITLE'),
						'TYPE' => 'checkbox',
						'DEFAULT' => 'Y',
						'THEME' => 'N',
						'ONE_ROW' => 'Y',
			...
			'PROJECTS_PAGE' => array(
				...
				'LIST' => array(
					...
					'list_elements_3' => array(
						...
						'IMG' => '/bitrix/images/'.$solution.'/themes/projects4.png',
						'ROW_CLASS' => 'col-md-4',
						'POSITION_BLOCK' => 'block',
					),
				),
	...
	'MOBILE' => array(
		...
		'OPTIONS' => array(
			...
			'MOBILE_CATALOG_LIST_SECTIONS_COMPACT' => array(
				'TITLE' => GetMessage('MOBILE_CATALOG_LIST_SECTIONS_COMPACT'),
				'TYPE' => 'checkbox',
				'DEFAULT' => 'Y',
				'THEME' => 'Y',
			),
			...
			'MOBILE_CATALOG_BREADCRUMBS' => array(
				'TITLE' => GetMessage('MOBILE_CATALOG_BREADCRUMBS'),
				'TYPE' => 'checkbox',
				'DEFAULT' => 'N',
				'THEME' => 'Y',
			),
