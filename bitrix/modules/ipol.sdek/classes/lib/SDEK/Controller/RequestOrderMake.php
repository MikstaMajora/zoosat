...
class RequestOrderMake extends AutomatedCommonRequest
{
    ...
    public function convert()
    {
        ...
        $this->requestObj
            ...
            ->setSender($this->generateSender()) // Sender company
            ->setSeller($this->generateSeller()) // Real seller
    ...
    private function generateDeliveryRecipientCost()
    {
        ...
        if (!is_null($payment->getNdsDelivery())) {
            ...
            $apiMoney
                ...
                ->setVatSum(($payment->getDelivery()->getAmount() * $payment->getNdsDelivery()) / 100);
        }
    ...
    private function generatePackages()
    {
        ...
        if($coreOrder->getField('packages')){
            ...
            $package
                ...
                ->setLength($goods->getLength())
                ->setHeight($goods->getHeight())
