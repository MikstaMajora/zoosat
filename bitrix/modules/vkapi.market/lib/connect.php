...
class Connect
{
    ...
    /**
     * Запрос к api вконтакте, вернет объект с результатом, если все хорошо или с ошибкой, елси в ответе вернется ошибка
     * 
     * @param $method - метод, например market.getAlbums
     * @param $params - парамтеры для метода, напрмиер array('owner_id' => '-105897', 'offset' => 0)
     * @param int $iteration - итерация, для повторного запроса, когда появляется необходимость ввода капчи, и нужно сделать повторный запрос
     * @return \VKapi\Market\Result
     * @throws \Bitrix\Main\ArgumentException
