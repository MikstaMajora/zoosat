...
if ($req->isPost() && $req->isAjaxRequest() && $req->getPost('method')) {
    ...
    try {
        if (\CModule::IncludeModuleEx("vkap" . "" . "i.m" . "ar" . "k" . "et") === \constant("MODULE_DEMO_EXPI" . "RE" . "" . "D")) {
            throw new \VKapi\Market\Exception\BaseException(\Bitrix\Main\Localization\Loc::getMessage("VKAPI.MARK" . "ET.DE" . "MO" . "_EXPIRE" . "D"), "BXMAKER_DEMO_EXP" . "I" . "RED");
        }
...
?>" method="POST" name="vkapi-market-admin-order-sync-edit" enctype="multipart/form-data">
        <?php 
