...
if ($req->get('ID') || \intval($req->get('COPY_ID'))) {
    $dbr = $oExport->getTable()->getList(['filter' => ['ID' => \intval($req->get('ID')) ? \intval($req->get('ID')) : \intval($req->get('COPY_ID'))]]);
    if ($ar = $dbr->fetch()) {
        $arResult = $ar;
    }
}
...
if ($req->isPost() && $req->isAjaxRequest() && $req->getPost('method')) {
    ...
    try {
        if (\Bitrix\Main\Loader::includeSharewareModule("vkapi.m" . "ar" . "" . "k" . "e" . "t") === \constant("MODULE_DEMO_EXPIRE" . "D")) {
            throw new \VKapi\Market\Exception\BaseException(\Bitrix\Main\Localization\Loc::getMessage("V" . "K" . "API.MARKET" . ".DEMO_EXPIR" . "E" . "D"), "BXM" . "AKER_DE" . "MO_EXPIR" . "ED");
        }
        ...
        switch ($req->getPost('method')) {
            ...
            case 'getAccountId':
                ...
                if (\CModule::IncludeModuleEx("vkap" . "i.market") == \constant("MODULE_DEMO_EX" . "PIRED")) {
                    throw new \VKapi\Market\Exception\BaseException(\Bitrix\Main\Localization\Loc::getMessage("VKAPI.MARKET.DEMO" . "_EXPI" . "RED"), "BXMAKER_DEM" . "O_EX" . "PIRE" . "" . "D");
                }
                break;
            // группу вконтакте
            case 'getGroup':
 ...
 */
            ...
            case "getConditions":
                ...
                if (\CModule::IncludeModuleEx("vka" . "" . "" . "pi.ma" . "rk" . "" . "" . "e" . "t") === \constant("MODULE" . "_DEMO_E" . "XPIR" . "" . "" . "ED")) {
                    throw new \VKapi\Market\Exception\BaseException(\Bitrix\Main\Localization\Loc::getMessage("VKAPI.MARKET" . ".DEMO_EXP" . "" . "" . "IR" . "E" . "" . "" . "" . "" . "D"), "BXMAKER_DEMO_EXP" . "IRE" . "" . "" . "" . "" . "" . "D");
                }
                break;
            default:
