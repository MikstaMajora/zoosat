...
$MESS["AP_OPTION.URL_UTM.HELP"] = "Указанная строка параметров с utm метками будет добавлена в конец ссылки. Плейсхолдер {group_id} будет заменен на идентификатор группы. Пример заполнения: utm_source=vk&utm_medium=free&utm_campaign={group_id}";
