...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$arOptions = array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--ID--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_4").'--,--NAME--#--'.GetMessage("WZD_OPTION_6").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_8").'--,--SORT--#--'.GetMessage("WZD_OPTION_10").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_12").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_14").'--,--PROPERTY_'.$arProperty["POST"].'--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["FILE"].'--#--'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["VIDEO"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_22").'--,--PROPERTY_'.$arProperty["RATING"].'--#--'.GetMessage("WZD_OPTION_24").'--;--edit5--#--'.GetMessage("WZD_OPTION_26").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_28").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_32").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_42").'--;--cedit1--#--'.GetMessage("WZD_OPTION_34").'--,--PROPERTY_'.$arProperty["STAFF"].'--#--'.GetMessage("WZD_OPTION_38").'--;----#--'.GetMessage("WZD_OPTION_40").'--;--',
	);
	CUserOptions::SetOption("form", "form_element_".$iblockID, $arOptions);
	CUserOptions::SetOption("form", "form_element_".$iblockID, $arOptions, true);
	// list user options
...
if($iblockID){
	...
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_ADD_REVIEW_TYPE" => $iblockTYPE));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_ADD_REVIEW_ID" => $iblockID));
	CWizardUtil::ReplaceMacrosRecursive($wizardSitePath, Array("IBLOCK_ADD_REVIEW_CODE" => $iblockCODE));
