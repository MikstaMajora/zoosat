		...
		<div class="logo-row">
			<div class="maxwidth-theme">
				<div class="row">
					...
					<?endif;?>
					<div class="col-md-<?=($arRegions ? 2 : 3);?> col-lg-<?=($arRegions ? 2 : 3);?> search_wrap_zoosat">
                    ...
                    <div class="col-md-2 top_social_zoosat" >
                        <div class="top_social_insta"><img src="/upload/imgs/icons/insta.png" alt=""></div>
                        <div class="top_social_vk">
                            <a href="https://vk.com/zoosat" target = "_blank">
                                <img src="/upload/imgs/icons/vk.png" alt="">
                            </a>
                        </div>
                    </div>
