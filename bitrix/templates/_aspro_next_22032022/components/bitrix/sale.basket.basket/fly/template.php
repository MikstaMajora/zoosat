...
<?endif;?>
	...
	<div class="opener">
        ...
        <div class = "fly_icon">
            <a href="tel:89137210055" class = "fly_icon_href">
                <img src="/upload/imgs/icons/phone.png"  class="fly_icon_phone" alt="">
            </a>
        </div>

        <div class = "fly_icon">
            <a href="mailto:manager@zoosat.ru"  target = "_blank" class = "fly_icon_href">
                <img src="/upload/imgs/icons/mail.png"  class="fly_icon_mail" alt="">
            </a>
        </div>

        <div class = "fly_icon">
            <a href="https://api.whatsapp.com/send/?phone=79137210055&text=Здравствуйте%2C+у+меня+есть+вопрос"  target = "_blank" class = "fly_icon_href">
                <img src="/upload/imgs/icons/whatsapp_text.png"  alt="">
            </a>
        </div>
