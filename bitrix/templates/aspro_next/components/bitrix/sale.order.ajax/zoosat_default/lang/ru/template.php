...
$MESS["SOA_ORDER_SUC"] = "Ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE# успешно создан и принят в обработку.";
...
$MESS["SOA_ORDER_SUC1"] = "<div class='soa_order_suc1'> В рабочее время <b> c 9.00  -  16.00 по Новосибирскому времени </b> с Вами свяжется менеджер для подтверждения и уточнений деталей заказа.</div>";
