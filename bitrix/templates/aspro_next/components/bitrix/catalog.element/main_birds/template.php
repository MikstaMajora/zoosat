				...
				<div class="prices_block">
					...
					<div class="quantity_block_wrapper">
						...
						<?if($arParams["SHOW_CHEAPER_FORM"] == "Y"):?>
                            ...
                            <div class="">
								<button class="animate-load btn-bird-order" data-event="jqm" data-param-form_id="CHEAPER_SB5ei" data-name="cheaper" data-autoload-product_name="<?=CNext::formatJsName($arResult["NAME"]);?>" data-autoload-product_id="<?=$arResult["ID"];?>"><?=($arParams["CHEAPER_FORM_NAME"] ? $arParams["CHEAPER_FORM_NAME"] : GetMessage("CHEAPER"));?></button>
							</div>
						<?endif;?>
					</div>
				</div>
