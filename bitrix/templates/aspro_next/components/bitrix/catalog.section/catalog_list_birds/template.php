			...
			<div class="list_item_wrapp item_wrap item ">
				...
				<table class="list_item" id="<?=$arItemIDs["strMainID"];?>">
					...
					<td class="description_wrapp item_info">
						<div class="description birds-list-block">
					...
					<td class="information_wrapp main_item_wrapper">
						<div class="information <?=($arItem["OFFERS"] && $arItem['OFFERS_PROP'] ? 'has_offer_prop' : '');?>  inner_content js_offers__<?=$arItem['ID'];?>">
							<div class="cost prices clearfix">
                                ...
                                <!-- Под заказ -->
                                <div class="">
                                    <button class="animate-load btn-bird-order" data-event="jqm" data-param-form_id="CHEAPER_SB5ei" data-name="cheaper" data-autoload-product_name="<?=CNext::formatJsName($arItem["NAME"]);?>" data-autoload-product_id="<?=$arItem["ID"];?>"> Оформить заявку </button>
                                </div>
