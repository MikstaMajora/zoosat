			...
			<div class="list_item_wrapp item_wrap item ">
				...
				<table class="list_item" id="<?=$arItemIDs["strMainID"];?>">
					...
					<td class="image_block<?=($arParams['GALLERY_ITEM_SHOW'] == 'Y' ? ' with-gallery' : '');?>">
						...
						<?php if($arItem['PROPERTIES']['SKIDKA20']['VALUE_XML_ID']){  ?>
                            <div class = "sale_icon_list" >
                                <img class = "sale_icon_img" src = "/upload/imgs/icons/sale20.png">
                            </div>
						<?php    }  ?>

						<?php if($arItem['PROPERTIES']['SKIDKA25']['VALUE_XML_ID']){  ?>
                            <div class = "sale_icon_list" >
                                <img class = "sale_icon_img" src = "/upload/imgs/icons/zoosat25.png">
                            </div>
						<?php    }  ?>

						<?php if($arItem['PROPERTIES']['SKIDKA15']['VALUE_XML_ID']){  ?>
                            <div class = "sale_icon_list" >
                                <img class = "sale_icon_img" src = "/upload/imgs/icons/zoosat15.png">
                            </div>
						<?php    }  ?>

						<?php if($arItem['PROPERTIES']['SKIDKA10']['VALUE_XML_ID']){  ?>
                            <div class = "sale_icon_list" >
                                <img class = "sale_icon_img" src = "/upload/imgs/icons/zoosat10.png">
                            </div>
						<?php    }  ?>
                        ...
                        <div class="image_wrapper_block">
	                        ...
	                        <?php if(!empty($arItem['CUSTOM_PROPS']['RASPRODAGA'])): ?>
