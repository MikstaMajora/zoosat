...
//    const priceCurrencySign = document.querySelector(".price_currency");
//    priceCurrencySign.textContent = " ₽";
//    console.log(priceCurrencySign)
...
$("#soa-property-7").prop('maxLength', 256);
