...
<?php /*
    <?php // Отображение на главной страницы меню каталога // ?>
...
*/ ?>
    ...
    <div class = "uslovia-img-banners">
	<a href="/help/delivery/" target = "_blank">
		<img src="/upload/imgs/dost3.jpg">
	</a>
    </div>

    <div class = "uslovia-img-banners">
        <a href="/sales/skidka-10-za-zakazy-ot-5000-rubley/" target = "_blank">
	        <img src="/upload/imgs/skid2.jpg">
        </a>
    </div>

    <div class = "uslovia-img-banners">
	<a href="/sales/25-na-korma-dlya-gryzunov-i-khorkov/" target = "_blank">
		<img src="/upload/imgs/gryz.png">
	</a>
    </div>
