...
if(isset($_GET)  && !empty($_GET)){
    ...
    $dir = $_SERVER['DOCUMENT_ROOT'].'/bitrix/download/images_zoosat/imagesnew/';
...
//debug($dom);
    ...
    if( $dom->save("images.xml") or die("error") ){
        echo '<div class="alert alert-success" role="alert"> Документ <a target = "_blank" href = "/local/dev/update_pics/images.xml"> images.xml </a> успешно создан! </div>';
    }
