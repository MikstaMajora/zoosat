...
if(isset($_GET)  && !empty($_GET)){
	...
	$urlRoot = $_SERVER['DOCUMENT_ROOT'].'/local/dev/update_add_material/images.xml';
...
//				} else {
            ...
            sort($arPics);
			CIBlockElement::SetPropertyValuesEx($elemObj['ID'], IBLOCKID, array("ADD_MATERIAL_IMG" => $arPics));
