...
define('HTML_FOR_DOWNLOAD', 'htmlnew'); //папка для загрузки
...
//Создает XML-строку и XML-документ при помощи DOM
    ...
    if( $dom->save("files.xml") or die("error") ){
        echo '<div class="alert alert-success" role="alert"> Документ <a target = "_blank" href = "/local/dev/update_files/files.xml"> files.xml </a> успешно создан! </div>';
    }
